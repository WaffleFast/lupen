const STORAGE_ACCOUNT_KEY = LupenSaveService.storageKeys.account;
...
let tradeMarketWindowStartedAt = 0;
let tradeMarketWindowCycle = null;
...
const DAILY_BOUNTY_CONTRACTS = [
  {
    ...
    bonus: "Complete your first combat contract and return for repairs.",
    timed: false,
